...
2. I am soliciting interested folks to help out with interiors, NPCs, and quests. I will manage the project by delegating tasks and integrating the results, and prioritizing my own work on things that others have not shown interest. Hopefully with more interested volunteers we can parallelize content creation and get to the end faster.

If you are interested in helping, please check out [the plan from now on](/windhelm/plan.md) and then let's chat. I have presence on NexusMods, reddit, and here on github.
